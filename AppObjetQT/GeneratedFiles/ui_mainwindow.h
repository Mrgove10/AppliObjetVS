...
public:
    ...
    QListWidget *listWidgetEtudiants;
    QWidget *tab_5;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayoutWidget_3->setGeometry(QRect(10, 10, 471, 708));
        ...
        adminAjout = new QPushButton(gridLayoutWidget_3);
        adminAjout->setObjectName(QStringLiteral("adminAjout"));

        gridLayout_3->addWidget(adminAjout, 22, 1, 1, 1);

        listWidgetAdmins = new QListWidget(tab_6);
        listWidgetAdmins->setObjectName(QStringLiteral("listWidgetAdmins"));
        listWidgetAdmins->setGeometry(QRect(490, 10, 881, 771));
        tabWidget->addTab(tab_6, QString());
        tab_4 = new QWidget();
        tab_4->setObjectName(QStringLiteral("tab_4"));
        gridLayoutWidget = new QWidget(tab_4);
        gridLayoutWidget->setObjectName(QStringLiteral("gridLayoutWidget"));
        gridLayoutWidget->setGeometry(QRect(10, 10, 471, 498));
        gridLayout = new QGridLayout(gridLayoutWidget);
        gridLayout->setSpacing(6);
        gridLayout->setContentsMargins(11, 11, 11, 11);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        etudiantAjout = new QPushButton(gridLayoutWidget);
        etudiantAjout->setObjectName(QStringLiteral("etudiantAjout"));

        gridLayout->addWidget(etudiantAjout, 15, 1, 1, 1);
        ...
        listWidgetEtudiants = new QListWidget(tab_4);
        listWidgetEtudiants->setObjectName(QStringLiteral("listWidgetEtudiants"));
        listWidgetEtudiants->setGeometry(QRect(490, 10, 881, 771));
        tabWidget->addTab(tab_4, QString());
        tab_5 = new QWidget();
        tab_5->setObjectName(QStringLiteral("tab_5"));
        gridLayoutWidget_2 = new QWidget(tab_5);
        gridLayoutWidget_2->setObjectName(QStringLiteral("gridLayoutWidget_2"));
        gridLayoutWidget_2->setGeometry(QRect(10, 10, 471, 429));
        ...
        profAjout = new QPushButton(gridLayoutWidget_2);
        profAjout->setObjectName(QStringLiteral("profAjout"));

        gridLayout_2->addWidget(profAjout, 13, 1, 1, 1);
        ...
        listWidgetProfs = new QListWidget(tab_5);
        listWidgetProfs->setObjectName(QStringLiteral("listWidgetProfs"));
        listWidgetProfs->setGeometry(QRect(490, 10, 881, 771));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_6), QApplication::translate("MainWindow", "Personel Administratif", nullptr));
